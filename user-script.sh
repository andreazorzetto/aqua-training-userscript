...
##TO DO: rename branch
helm upgrade --install jenkins jenkins/jenkins --version 3.7.1 -n jenkins --create-namespace -f https://raw.githubusercontent.com/andreazorzetto/aqua-training-userscript/andrea/jenkins_3.8.3_values.yaml