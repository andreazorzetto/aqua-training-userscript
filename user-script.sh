...
##TO DO: rename branch
helm upgrade --install jenkins jenkins/jenkins --version 3.8.3 -n jenkins --create-namespace -f https://raw.githubusercontent.com/andreazorzetto/aqua-training-userscript/0.2.1/jenkins_3.8.3_values.yaml --set controller.adminUser=$username,controller.adminPassword=$password
